...
class CreateCategory(PermissionRequiredMixin, CreateView):
    permission_required = ['products.create_categories']
    raise_exception = True
    ...
    def get_context_data(self, **kwargs):
        ...
        category_list = ProductCategory.objects.all().order_by('-pk')[:10]
    ...
    def get_success_url(self):
        ...
        messages.success(self.request, 'Success, new categories created', extra_tags='alert alert-success')

        return reverse_lazy('products:add-categories')
